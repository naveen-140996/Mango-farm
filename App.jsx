...
function App() {
  ...
  const accordionItems = [
    { title: 'How Does M/S Holiday Mango Farms Select Its Farmland Projects?', content: 'At M/S Holiday Mango Farms, We Take A Meticulous Approach In Choosing Our Projects. Our Selection Process Involves Thorough Scrutiny To Ensure That The Farmlands Are Not Only Fertile But Also Tailored To Be Investor-Friendly. We Prioritize Locations With Ideal Soil Conditions, Climate, And Accessibility To Create A Successful Investment Environment.' },
    { title: 'loremlorem Item 2', content: 'lorem loremloremloremloremloremloremloremloremloremloremloremlorem ' },
    { title: 'loremloremlorem Item 3', content: 'Content of Accordion Item 3loremloremloremloremloremloremloremloremloremloremloremloremloremlorem' },
    ...
    <section id="home">
      <div className='bg-image'>
        <div className={`container ${isSticky ? 'sticky' : ''}`}>
         ...
         <nav  className="navbar-mobile" >
            ...
            <ul  className={`menu ${isMenuOpen ? 'active' : ''}`}>
              ...
              <li><a href="#contact">Contact</a></li>
              <li><button type='button' class="close-menu" id="close-btn" onClick={closeMenu}>X</button></li>
            </ul>
          </nav>
        </div>
        <div className='form-section'>
            <div className='left-side-section'>
               <h5>
                  Tiruttani Mango Farm  Your Investment in Lush Mango Groves
               </h5>
               <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Magni omnis necessitatibus assumenda obcaecati architecto at sit culpa? Natus quisquam nam debitis commodi adipisci dolore fugiat odit quidem illum, eum iure!</p>
            ...
            <div className='right-side-section'>
              <div className='form-section-inner'>
                ...
                <form action="" onSubmit={handleSubmit}>
                  <div>
                    <input type="text" placeholder='Enter your Name*' name="name" value={formData.name}  className='form-contol' onChange={handleChange}/>
                  </div>
                  <div>
                    <input type="text" placeholder='Enter your city*' name="city" value={formData.city} className='form-contol' onChange={handleChange}/>
                  </div>
                  <div>
                    <input type="text" placeholder='Enter your PhoneNo*' name="phone" value={formData.phone} className='form-contol' onChange={handleChange}/>
                  </div>
      ...
      <section id="services">
        <div className='dream-section' >
          ...
          <div className='dreams-right-section w-50'>
              ...
              <p className='about-parahraph'>Established just two years ago, Tiruttani Mango Farm has become a leading provider of mango farm land for sale in Tiruttani. We offer a unique and lucrative investment opportunity, allowing you to sow the seeds of financial growth in the vibrant fields of agriculture. Enter the world of Tiruttani Mango Farm, where our commitment to excellence and agricultural expertise promises a rewarding journey for both our farms and your investments.</p>
              <button className='book-btn about-btn' onClick={openModal}>Book Now</button>
      ...
      <section className='counter-section'>
        <div className='text-center'>
          <div ref={counterRef1} className="counter">{partnerCount1}+</div>
          <p className='years-inner'>2 Years Successful Ventures</p>
        </div>
        <div className='text-center'>
          <div ref={counterRef2} className="counter">{partnerCount2}+</div>
          <p className='years-inner'>25+ Satisfied Partners</p>
        </div>
        <div className='text-center'>
          <div ref={counterRef3} className="counter">{partnerCount3}+</div>
      ...
      <section className='our-gallery-section' id="gallery">
            ...
            <div className="slider-container">
                ...
                {springs.map((style, index) => (
                  <animated.div key={index} style={style} className='animated-img'>
                    <img src={slide[index].imageUrl} alt={`Slide ${index + 1}`} width={"100%"} className={index === centerIndex ? 'center-image' : 'side-image'}/>
                  </animated.div>
                ))}
                </Slider>
            </div>
      ...
      <section className='contact-us' id="contact">
        <div className='contact-us-inner-section'>
            <div className='contact-left-side w-50'>
                ...
                <p className='contact-left-inner-para'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ut blanditiis ducimus incidunt sint, sunt modi soluta voluptates nostrum qui culpa consequatur molestiae quaerat? Nostrum dignissimos obcaecati voluptates! Amet, aperiam temporibus.</p>
            ...
            <div className='right-side-section'>
              <div className='form-section-inner'>
                ...
                <form action="">
                  <div>
                    <input type="text" placeholder='Enter your Name*' className='form-contol'/>
                  </div>
                  <div>
                    <input type="text" placeholder='Enter your city*' className='form-contol'/>
                  </div>
                  <div>
                    <input type="text" placeholder='Enter your PhoneNo*' className='form-contol'/>
                  </div>
                  <button type='submit' className='sign-up-btn contact-us-btn'>Sign up</button>
                </form>
              </div>
            </div>
        </div>
      ...
      <section className='footer'>
        <div className='footer-section-inner'>
          <div className='w-50'>
            ...
            <p className='footer-para'>Established just two years ago, M/S Holiday Mango Farms has quickly become a notable player in the agribusiness sector, offering a unique and alluring investment opportunity.  </p>
            <div class="home-sci">
                <a href="https://www.facebook.com/" target="_blank"><i class="bx bxl-facebook"></i></a>
                <a href="https://www.instagram.com/" target="_blank"><i class="bx bxl-instagram"></i></a>
                <a href="https://api.whatsapp.com/send?phone=9876543210" target="_blank"><i class="bx bxl-whatsapp"></i></a>
                <a href="https://www.linkedin.com/in/naveen-kumar-v-723962237/" target="_blank"><i class="bx bxl-linkedin"></i></a>
            </div>
          </div>
          <div className='our-links'>
            <ul>
                  ...
                  <li><a href="/contact">FARMING</a></li>
                </ul>
          </div>
          <div className='our-links'>
            <ul>
